...
### Changed
- **The video editor, rebuilt from the ground up.** A new layout: a big preview, a tabbed inspector (Style · Cursor · Zoom · Camera · Captions · Audio) whose panel turns into a dedicated editor when you select something, and a full-width timeline. The toolbar lives in the title bar with aspect ratio, undo/redo, commands, and Export.
